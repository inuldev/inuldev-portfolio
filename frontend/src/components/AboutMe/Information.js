      ...
      <div className="aboutme-bx wow">
        ...
        <Row className="abtcont">
          ...
          >
            ...
            <div className="mtopsome" onClick={() => setIsOpen(!isOpen)}>
              <motion.div
                layout
          ...
          <Col md={6} xl={7} className="abtmerow">
            <div className="pinfo">
              <div className="boxcont">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Detail src={email} name="Email" value={aboutDetails.email} />
                  <Detail
                    src={phone}
                    name="Phone"
            ...
            >
              ...
              >
                <img src={language} alt="Error" className="img" />
                Languages Known
              </motion.h3>
              <motion.div
                className="boxCont"
              ...
              >
                {languagesKnown?.map((language) => (
                  <LangCard key={language._id} name={language.name} />
                ))}
              </motion.div>
            </div>
          </Col>

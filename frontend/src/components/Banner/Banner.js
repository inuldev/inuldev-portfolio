    ...
    >
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={6} xl={7}>
            <motion.span variants={itemA} className="tagline">
              Welcome to my portfolio!
            </motion.span>
            <motion.h1 variants={itemA}>
              <Typewriter
                options={{
                  strings: ["Web Developer", "Computer Engineer", "Freelancer"],
                  autoStart: true,
                  loop: true,
                  delay: 70,
                  deleteSpeed: 40,
